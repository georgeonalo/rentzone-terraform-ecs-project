...
resource "aws_subnet" "private_app_subnet_az1" {
  ...
  tags      = {
    Name    =  "${var.project_name}-${var.environment}-privat-app-az1"
  }
}
...
resource "aws_subnet" "private_app_subnet_az2" {
  ...
  tags      = {
    Name    =  "${var.project_name}-${var.environment}-privat-app-az2"
  }
}
...
resource "aws_subnet" "private_data_subnet_az1" {
  ...
  tags      = {
    Name    = "${var.project_name}-${var.environment}-privat-data-az1"
  }
}
...
resource "aws_subnet" "private_data_subnet_az2" {
  ...
  tags      = {
    Name    = "${var.project_name}-${var.environment}-privat-data-az2"
  }
}